	...
	public cadealt() {
		...
		btnExcluirDigital.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (nome.getText().equals("") || !user.getText().equals(useradm) || !String.valueOf(password.getPassword()).equals(passadm) ) {
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (digitalLida == null || nome.getText() == null || comboBox.getSelectedItem() == "---" || !user.getText().equals(useradm) || !String.valueOf(password.getPassword()).equals(passadm)) {
					JOptionPane.showMessageDialog(null, "Dados incorretos / faltantes");
				}
				else {
					try {
						dao.writeDataBase(nome.getText(), Integer.parseInt((String)comboBox.getSelectedItem()), digitalLida);
